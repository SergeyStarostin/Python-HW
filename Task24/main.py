...
number_berries = [random.randint(1, 10) for i in range(number_bushes)]
print(number_berries)

number_berries = number_berries + number_berries[:2]
maximum_quantity = 0
for i in range(number_bushes):
    maximum_quantity = max(maximum_quantity, number_berries[i] + number_berries[i+1] + number_berries[i+2])
print(f'Максимальное количество ягод на 3 соседних кустах = {maximum_quantity}')