...
def rhythm(song):
    song = song.split()
    word = [sum(letter in 'аеёиоуыэюя' for letter in syllable) for syllable in song]
    result = 'Парам пам-пам' if len(set(word)) == 1 else 'Пам парам'
    return result

song = input('Введите песню Винни-Пуха: ')
print(rhythm(song))
